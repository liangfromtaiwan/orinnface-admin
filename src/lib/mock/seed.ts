...
customers.forEach((c, i) => {
  ...
  storeDataLinks.push({
    ...
    // 同意は連携より先に取るので、解除済みでも当時の同意日時は残る
...
recommendationRuns.forEach((run, i) => {
  ...
  // Guest は標準動画を再生できない (推奨は lock 表示 + 登録 CTA)。
...
export const auditEvents: AuditEvent[] = [
  { category: "image_access", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "ria_003_1", reason: "顧客からの問い合わせ対応 (品質確認)", daysBack: 0.2 },
  ...
  { category: "baseline_change", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "rb-2026.09.1 draft 作成", reason: "8月実測反映", daysBack: 4 },
  { category: "policy_change", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "rp-2026.09.1 承認", reason: "tie-break 方針変更", daysBack: 6 },
  { category: "role_change", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "acc_store_admin に st_lumiere_shibuya の store_admin を付与", reason: "担当店舗追加", daysBack: 9 },
  ...
  { category: "rollback", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "rb-2026.07.1 → rb-2026.08.1 (新 version として実行)", reason: "基準値の想定外の影響", daysBack: 35 },
  { category: "image_access", actorName: "吉田", actorAccountId: "acc_operator", targetLabel: "ria_017_0", reason: "AI 誤判定調査", daysBack: 41 },
